...
// Réglage des collisiontirent des ennemis sortant de l'écran
...
fn enemy_shoot_system(
    ...
    // 2. ON OUVRE LA BOÎTE ICI avec .get_single().expect(...)
    let window = window_q.single().expect("Pas pu trouver la fenêtre !");
