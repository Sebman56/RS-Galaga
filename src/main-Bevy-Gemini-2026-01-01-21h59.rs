...
//
//
// manque utilisation des touches "Q" "X" pour sortir, "P" pour pause, "R" pour recommencer le jeu
...
fn input_system(
    ...
    entities_q: Query<Entity, Or<(With<Enemy>, With<Bullet>, With<Player>, With<Explosion>, With<FloatingScore>)>>,
) {
    // QUITTER : Q ou X
    if kb.just_pressed(KeyCode::KeyQ) || kb.just_pressed(KeyCode::KeyX) || kb.just_pressed(KeyCode::Escape) {
